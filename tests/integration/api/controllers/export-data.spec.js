...
describe('Export Data V2.0', () => {
  ...
  describe('GET|POST /api/v2/export/contacts', () => {
    const contacts = [
      ...
      { _id: 'jen_id', name: 'jen', type: DOC_TYPES.CONTACT, contact_type: 'chw', patient_id: '123', other_field: 'value' },
      ...
      { _id: 'ny_id', name: 'new york', type: DOC_TYPES.CONTACT, contact_type: 'city', place_id: '231', phone: '0054852' },
      {
        _id: 'michael_id',
        name: 'michael',
